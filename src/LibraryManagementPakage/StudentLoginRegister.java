    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        // TODO add your handling code here:
         try {
            ...
            login = (PreparedStatement) con.prepareStatement("SELECT * FROM student WHERE userId=? and password=?");
            ...
            if(rs.next()) {
                ...
                new StudentInterface(user, pass).setVisible(true);
                this.setVisible(false);
                //cleanTxt();
            } else {
            ...
            Logger.getLogger(StudentLoginRegister.class.getName()).log(Level.SEVERE, null, ex);
        }
